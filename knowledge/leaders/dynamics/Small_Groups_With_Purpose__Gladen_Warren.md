...
# Small Groups With Purpose — Gladen & Warren · Source Summary

| Product: Group Leader eCoach | Type: RAGSRC (source summary) | Owner: Ned | Review: F2 information map / F3 agent test | v1.0 | June 2026 |
| :---- |

**Source:** Steve Gladen with Rick Warren, *Small Groups With Purpose: How to Create Healthy Communities* (Baker Books, 2011). ~66.6K words.
**Tagged against:** Group eCoach Tag Register (10 domains · 60 leaves · 22 situations · 6 handoffs).
**Reach note:** N0 maps this book to A2.1 / A6.3 / A5.2. In practice its strongest material is A9 (distributing leadership) and it makes a useful contribution to A10 (the corpus's thinnest domain) and A1.2/A1.4 — so this summary tags to the book's actual reach, per the broaden-then-prune decision. The N0 row should be updated to reflect A9 + A10 + A1.2.
**Translation note:** This is a church small-groups book; its organizing frame is the "five biblical purposes" (fellowship, discipleship, ministry, evangelism, worship). Where a concept generalizes, it is translated into secular shared-purpose / group-health terms and the religious origin is named honestly in a `Source reach:` line. Flagship examples are chosen to retell without doctrine.
...
**1. Health is the real goal, not growth.** Gladen opens by rejecting the headcount metric: the issue for groups "will be health, not growth." This reframes everything that follows — every later move is judged by whether it makes members healthier, not whether it adds bodies.
concepts: [A6.3 cohesion-and-belonging] [A10.6 satisfaction-and-retention]

**2. Principles transfer; methods don't.** He distinguishes the message (durable principles) from the method (context-bound tactics), warning leaders not to copy another group's mechanics wholesale. This licenses the reader to adapt, and frames the book as principles to translate rather than a playbook to clone.
concepts: [A2.1 shared-purpose]

**3. Define success first.** Before choosing any structure, name the end-state you want to produce; without it a group floods to fellowship-only and people drift out. This sets up community (next) as something to be *led toward depth*, not merely convened.
concepts: [A2.1 shared-purpose] [A5.3 goal-design]

**4. Community is the foundation — but it must be led.** Fellowship is the glue and the safe ground for everything else, yet it will not deepen on its own; left alone a group stalls in social comfort. Hence the leader's job shifts from convening to directing, and from teaching to facilitating.
concepts: [A6.3 cohesion-and-belonging] [A2.3 values-as-glue] [A1.2 enabling-vs-doing]

**5. Don't lead alone — distribute the work and develop everyone.** The leader deploys others' gifts (Jethro), refuses to be a "ministry hog," and spreads ownership through "purpose champions." This is the book's load-bearing move and where it runs deepest: leadership as functions met by many, not a title held by one.
concepts: [A9.2 delegating-outcomes-not-tasks] [A9.5 functional-shared-leadership] [A1.2 enabling-vs-doing]

**6. Recruit on potential and support your leaders.** Get willing people leading early, then build the support and development around them. This pairs with move 5: distributing leadership only works if new leaders are recruited generously and not abandoned once asked.
concepts: [A9.1 developing-leaders] [A1.4 stepping-into-the-role]

**7. Sustain yourself and keep learning.** Gladen closes on the leader's inner game: check your motivation, guard against burnout ("your work for God can destroy the work of God in you"), stay humble, and treat feedback as fuel ("all leaders are learners"). The argument lands where it began — health, now applied to the leader.
concepts: [A10.2 leader-self-care] [A10.1 volunteer-burnout] [A6.6 learning-together]

---

## Layer 2 — Concept Entries

### Define success before you fill the room
...
- **Why it matters / evidence:** For a first-time leader this is the cheapest high-leverage move: ten minutes naming "what is this group *for*" prevents months of drift. The book's whole-system claim is that vision must be defined at the top and carried down so everyone moves the same direction — but the leaf a volunteer owns is their own group's purpose [A2.3].
- **Related concepts:** vision over needs [A2.1] (how you then communicate the purpose); community must be led [A6.3] (purpose is what gives community its direction); health, not growth [A10.6] (purpose is defined in terms of health, not numbers).

### Vision over needs: cast it through story, don't sell it
...
- **Why it matters / evidence:** This is the antidote to the transactional ask a first-timer defaults to ("we need someone to bring snacks"). Reframing the same request inside a vision ("we're building a group where people are actually known") changes whether it lands. The book offers this as practical wisdom rather than studied evidence — see reach note.
- **Related concepts:** define success [A2.1] (you can only cast a vision you've defined); transactional-vs-relational ask [A3.3] (vision-casting is the relational mode); public narrative [A2.2] (story of self/us/now is the same mechanism, named by Ganz).
- **Source reach:** The "give to a vision not to needs" formulation is the book's own assertion, illustrated not evidenced; attribute as Gladen's practitioner claim and let Ganz [A2.2] carry the theoretical weight.

### Start new groups rather than splitting the one you have
...
- **Why it matters / evidence:** A first-time leader watching their group swell needs to know that bigger is not better and that intimacy has a ceiling — but the *response* (split vs. seed a new group) is largely the org's program decision [H:org-level]. The book treats this as field-tested practice across "books from churches around the world," not as a measured threshold.
- **Related concepts:** community must be led [A6.3] (size is a precondition for the depth community needs); health, not growth [A10.6] (the whole point is that adding bodies can destroy a group); shared ownership [A3.2] (harder to sustain once a group is oversized).
- **Source reach:** The book gives no member-count rule; the "real-team" size figure (3–7) comes from Fisher, not here. Attribute the *prefer-to-seed-not-split* stance to Gladen and route multiplication mechanics to the org.

### Written group guidelines, set at the first session
concepts:    [A5.5 norms-and-operating-agreements] [A5.7 launch-and-relaunch]
...
- **Why it matters / evidence:** For a first-timer this converts vague anxiety ("what if someone dominates / no one shows up") into a one-page agreement made openly, which is far easier than confronting the same problem mid-stream [A8.4]. The *content* of norm-setting belongs here; the run-the-meeting mechanics route out [H:events].
- **Related concepts:** define success [A2.1] (guidelines encode the purpose); how norms become culture [A6.1] (written norms harden into the group's way of being); shared ownership [A3.2] (attendance norms work because members feel counted on).
- **Source reach:** Thin — a practice statement, not a developed argument. Attribute lightly and let A5/A6 sources carry the why.

### Community won't deepen on its own
concepts:    [A6.3 cohesion-and-belonging] [A2.3 values-as-glue]
...
- **Why it matters / evidence:** A first-time leader often believes a good group is one where everyone likes each other — this says liking each other is the floor, and the leader's added value is pushing past it. The sign of real community, per the book, is members spending time together *outside* meetings.
- **Related concepts:** define success [A2.1] (direction requires a defined purpose); shared ownership [A3.2] (a lever for depth); facilitate, don't teach [A1.2] (how the leader directs without dominating).
- **Source reach:** "Goes below the surface" is asserted with conviction but little mechanism; pair with Coyle/Edmondson [A6.5] when the coach needs the *how* of safety and depth.

### Shared ownership is what gets people to show up
...
- **Why it matters / evidence:** This is the book's most directly usable answer to the most common first-leader complaint — "people aren't showing up." The lever isn't better reminders; it's giving people something the group genuinely needs them for [S:low-attendance]. Offered as practitioner observation rather than measured effect.
- **Related concepts:** purpose champions [A9.5] (the structured form of shared ownership); don't lead alone [A1.2] (ownership only exists if the leader lets go of tasks); satisfaction-and-retention [A10.6] (responsibility is a retention mechanism).

### Name the elephant: growing through conflict
...
- **Why it matters / evidence:** First-time leaders tend to hope conflict resolves itself; this says the leader's job is to make the first move toward naming it, and models a low-drama opener anyone can use. The book frames conflict as a normal, even productive phase of group life rather than a failure.
- **Related concepts:** community must be led [A6.3] (the leader directs through lows, not just highs); psychological safety [A6.5] (naming hard things requires and builds safety); repair [A8.5] (the goal is a stronger tie, not just a truce).
- **Source reach:** One anecdote, no framework; for technique pair with Stone/Patton/Heen [A8.1] (Difficult Conversations). Attribute the *stance* (name it early) to Gladen.

### Collective care: love into action
concepts:    [A10.4 collective-care]
situations:
handoff:
anchors to:
source:      Gladen — *Small Groups With Purpose*, ch.5
...
- **Why it matters / evidence:** For a volunteer leader prone to being the group's sole caretaker, this reframes care as a group capacity to cultivate, not a personal duty to shoulder — which is also a burnout guard [A10.2]. Practitioner illustration, not evidence.
- **Related concepts:** shared ownership [A3.2] (care is ownership of each other); don't lead alone [A1.2] (the leader receiving care is the same letting-go muscle); cohesion [A6.3] (practical care is how belonging becomes real).
- **Source reach:** The book's heaviest care example (the Kevin & Susan stillbirth) is more faith-laden; the dryer story is used here as the retell-ready secular illustration. *Prune candidate: could fold into "shared ownership" if the corpus needs fewer A10 entries.*

### Facilitate, don't teach: throw the ball and stay quiet
concepts:    [A1.2 enabling-vs-doing] [A7.3 autonomy-vs-direction]
...
- **Why it matters / evidence:** A first-time leader often equates leading with talking; this names the opposite skill — engineered silence — as the one that produces a participatory group. It's the conversational form of the book's whole "don't do it all yourself" thesis.
- **Related concepts:** don't lead alone [A1.2] (same muscle, applied to discussion); autonomy-vs-direction [A7.3] (the leader sets the question, members own the answer); shared ownership [A3.2] (talking is the entry-level form of owning).

### Don't lead alone: the Jethro principle
...
- **Why it matters / evidence:** This is the book's central, most transferable principle and a direct answer to "I'm doing everything myself" and "I'm burning out." Putnam, quoted in the chapter, reframes the leader's real job as recruiting/training/retaining other leaders — i.e., the bottleneck *is* the job to dismantle [A10.1].
- **Related concepts:** ministry hogs [A9.2] (the behaviour to stop); purpose champions [A9.5] (the structure that replaces it); guard against burnout [A10.2] (the personal stakes of not delegating).

### Ministry hogs: stop doing all the work
concepts:    [A9.2 delegating-outcomes-not-tasks] [A1.5 fear-of-asking-or-delegating]
...
- **Why it matters / evidence:** For the over-functioning first-timer (the most common type), this reframes "I'll just do it, it's faster" as the thing actively preventing the group from growing leaders. The fix is uncomfortable but simple: let a gap appear so someone fills it [A1.5].
- **Related concepts:** Jethro principle [A9.3] (the why); purpose champions [A9.5] (the structured handoff); graduated delegation [A9.1] (how to hand off without dropping the ball).
- **Source reach:** *Prune candidate: heavily overlaps the Jethro entry; keep separate only if the coach wants the "ball-hog / let it not happen" framing distinct from the Moses parable.*

### Purpose champions: distribute the dimensions of group health
concepts:    [A9.5 functional-shared-leadership] [A3.2 ownership-and-voice]
...
- **Why it matters / evidence:** This is the structural answer to both "no one takes initiative" and "it's all on a few people": the leader designs roles that make initiative the default. It also surfaces leadership in people who'd never have volunteered for a titled job.
- **Related concepts:** shared ownership [A3.2] (champions are ownership made structural); match by strengths [A5.1] (how you assign champions); don't lead alone [A9.2] (the principle this operationalises).

### Match people to roles by their strengths
concepts:    [A5.1 composition-and-skills] [A9.6 coaching-group-members]
situations:  [S:no-one-takes-initiative]
handoff:
anchors to:  Don't lead alone — every member a minister
source:      Gladen — *Small Groups With Purpose*, ch.7
...
- **Why it matters / evidence:** For a first-timer this prevents the classic mistake of begging anyone to take any open role; matching strengths to roles is what makes delegation *stick*. The S.H.A.P.E. acronym is church-specific packaging of a general idea — composition by task-relevant strengths.
- **Related concepts:** purpose champions [A9.5] (what you're matching people into); composition [A5.1] (Fisher's task-relevant-skills, same principle); coaching members [A9.6] (helping people discover their fit).
- **Source reach:** S.H.A.P.E. is presented as Saddleback's tool, not validated instrument; attribute as a practical discovery framework and let Fisher [A5.1] carry composition theory. (`org-check`: keep this at the leader's own-group altitude, not program staffing.)

### Develop members into leaders: Know, Grow, Go, Show
concepts:    [A9.1 developing-leaders] [A9.6 coaching-group-members]
situations:  [S:no-one-takes-initiative]
handoff:
...
- **Why it matters / evidence:** This gives a first-time leader a checklist against their own behaviour: am I only on "Go," forgetting "Show"? Am I asking vaguely? It pairs the inner conviction (everyone has something) with the operational discipline (make the ask specific).
- **Related concepts:** leadership potential [A9.1] (the recruiting half of development); match by strengths [A5.1] (what "Grow" works on); recognition [A10.3] (the "Show" step, often dropped).
- **Source reach:** Thin as a mechanism; the four verbs are a mnemonic, not a studied model. Attribute as Gladen's practitioner framework.

### Graduated delegation: sentence, section, study
...
- **Why it matters / evidence:** This is the most retell-ready answer to "I can't let go" — it makes letting go gradual and low-risk for both sides. It also models that rotation develops *everyone*, not just the obvious successor, by pushing each member slightly past their comfort zone in a supportive setting.
- **Related concepts:** ministry hogs [A9.2] (the habit this cures); leadership potential [A9.1] (develop on the job, in steps); facilitate, don't teach [A1.2] (each step hands more of the room to a member).
...
- **Why it matters / evidence:** This directly addresses "I can't recruit" and "I'm scared to ask": the fix is to make the ask smaller and the bar lower, not to find better people. It pairs with graduated delegation — you can bet on potential *because* you'll develop them in steps [A9.1].
- **Related concepts:** graduated delegation [A9.1] (how potential becomes skill); the ask / escalating commitment [A3.5] (recruiting mechanics → H:recruitment); stepping into the role [A1.4] (the new leader's side of the same coin).

### Guard against burnout: the work can destroy the worker
concepts:    [A10.2 leader-self-care] [A10.1 volunteer-burnout]
...
- **Why it matters / evidence:** This is high-value for the corpus's thinnest domain and speaks straight to the burning-out leader: the antidote isn't more efficiency, it's protected limits — and, connecting back to the book's spine, *distributing the work* so you're not the bottleneck [A9.3]. Offered as hard-won practitioner reflection.
- **Related concepts:** don't lead alone [A9.3] (delegation is a burnout guard); collective care [A10.4] (let the group care for you too); satisfaction-and-retention [A10.6] (the leader's own staying-power).
- **Source reach:** Faith-framed (Sabbath, prayer); translate the principle as protected rest and bounded commitment, name the religious origin, and let Heifetz/Colonna carry A10 depth when summarized.

### All leaders are learners: the anonymous 360
...
- **Why it matters / evidence:** For a first-time leader this normalises not-knowing and gives a concrete, low-cost practice (a periodic anonymous ask) that builds the reflective habit before a crisis forces it. It also models that the leader is inside the learning, not above it [A1.6].
- **Related concepts:** effective, not perfect [A1.6] (learning presumes imperfection); productive dissent [A8.2] (anonymity surfaces the dissent you need); leading up [A9.7] (the same openness to input from below).
- **Source reach:** The 360 practice is described, not evaluated; attribute as Gladen's own routine.

### Leading up and "everyone poops": don't suppress newcomers
concepts:    [A9.7 onboarding-newcomers] [A8.2 productive-dissent]
...
- **Why it matters / evidence:** This connects onboarding to dissent: groups where newcomers learn to stay quiet become groups where "everyone just agrees," and lose both the new people and their fresh sight. The cheap practice is explicit permission, early, to push back.
- **Related concepts:** all leaders are learners [A6.6] (newcomer input is feedback); psychological safety [A6.5] (the precondition for leading up); productive dissent [A8.2] (guarding against premature consensus).
- **Source reach:** Brief and anecdotal; attribute the "leading up / don't suppress" stance to Gladen and pair with Hirschman [A8.2] for the voice-vs-exit mechanism.

---

## Layer 3 — Relationship Map

- **Define success ↔ Community must be led** — [A2.1] × [A6.3]: a defined purpose is what gives the leader something to *direct community toward*; without it, "leading" community has no destination and the group defaults to fellowship-only. (Entries: "Define success before you fill the room", "Community won't deepen on its own")
- **Shared ownership ↔ Low attendance** — [A3.2] × [A6.4/A10.6]: people show up for what they feel responsible to, so giving members real ownership is the lever on attendance, not reminders. (Entries: "Shared ownership is what gets people to show up", "Purpose champions")
- **Don't lead alone ↔ Burnout** — [A9.3] × [A10.1]: the founder bottleneck and leader burnout are the same failure seen from two sides — distributing the work is simultaneously a development move and a self-care move. (Entries: "Don't lead alone: the Jethro principle", "Guard against burnout")
- **Purpose champions ↔ Match by strengths** — [A9.5] × [A5.1]: distributing leadership only works if roles are matched to genuine strengths; champions assigned by availability rather than fit don't hold. (Entries: "Purpose champions", "Match people to roles by their strengths")
- **Leadership potential ↔ Graduated delegation** — [A9.1] × [A1.2]: you can safely bet on unproven people *because* you hand off in small, supported increments — the recruiting stance and the development method are interdependent. (Entries: "Leadership potential, not proven leaders", "Graduated delegation: sentence, section, study")
- **All leaders are learners ↔ Leading up** — [A6.6] × [A8.2]: the anonymous feedback loop and protecting newcomers' dissent are one disposition — the leader who doesn't have all the answers — applied to the team and to new members respectively. (Entries: "All leaders are learners", "Leading up and 'everyone poops'")
- **Health, not growth ↔ Start new groups vs. splitting** — [A6.3] × [A5.2]: because the metric is health, not headcount, the response to a too-big group is about preserving intimacy, not maximising bodies. (Entries: "Community won't deepen on its own", "Start new groups rather than splitting")

---

## Excluded from this summary

Cut as church-specific or routed to the organization, with the choice logged for review:

- **Book of Acts exegesis** (ch.3) and the **biblical/theological framing** throughout — doctrinal grounding with no bearing on leading a secular distributed-organizing group.
- **Spiritual formation** (ch.6), **worship** (ch.9), and the **Spiritual Health Assessment tool** (ch.10) — faith-practice content specific to a church small group.
- **"The Church with No Walls" / evangelism** (ch.8) — outward conversion of nonbelievers; the generalizable kernel (groups grow through outward-facing shared activity) is thin and is better carried by other A2.4 sources.
- **Training pathway, organizational infrastructure, "host" model, strategic-care categories** (ch.11–14) — program-level design for *staff running a small-group ministry*, not the volunteer leader's own group → **H:org-level** (with the leader-facing slivers, e.g. written guidelines and graduated delegation, pulled into Layer 2).
- **Sunday school vs. small groups; campaign / multiplication / "exponential power" strategy** (ch.15–17) — cross-group and church-wide growth strategy → **H:org-level**.
- **The five biblical purposes as doctrine** — retained only in translated, secular form (a group balancing multiple dimensions of group life); the religious content itself is excluded.

---

*Tectonica.AI | Group Leader eCoach · RAGSRC source summary · Gladen & Warren, Small Groups With Purpose | v1.0 | June 2026 | Internal use. Provenance: summarized & tagged from the uploaded source against Tag Register v(current); quotes verified verbatim against source text.*

<!-- SEARCH_TERMS
gladen & warren — small groups with purpose | small groups with purpose
domains: A1 | A2 | A5 | A6 | A9
leaves: A1.2 A1.4 A1.5 A1.6 A10.1 A10.2 A10.3 A10.4 A10.6 A2.1 A2.2 A2.3 A3.2 A3.3 A3.5 A5.1 A5.2 A5.3 A5.4 A5.5 A5.7 A6.1 A6.3 A6.4 A6.5 A6.6 A7.2 A7.3 A8.1 A8.2 A8.4 A8.5 A9.1 A9.2 A9.3 A9.5 A9.6 A9.7
keywords: identity | stepping-into-leadership | leading-without-authority | imposter | purpose | story | shared-identity | values | goal-clarity | narrative | structure | group-design | norms | roles | meeting-rhythm | org-level-boundary | dynamics | lifecycle | momentum | psychological-safety
situations: burning-out cant-recruit conflict-got-personal decisions-keep-getting-relitigated doing-everything-myself everyone-just-agrees group-feels-transactional group-lost-its-why group-too-big-or-chaotic i-cant-let-go lost-momentum-after-launch low-attendance newcomers-dont-stick no-one-takes-initiative scared-to-ask-people two-members-clashing unclear-what-were-doing volunteers-flaky work-is-all-on-a-few-people
-->
