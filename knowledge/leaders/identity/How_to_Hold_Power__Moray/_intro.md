...
# Source Summary — *How to Hold Power* (Moray)

**product:** Group Leader eCoach · **code:** RAGSRC-Moray · **owner:** [you] · **review milestone:** post-first-tag-test prune · **version:** v1.1 · **date:** 2025

*Source: Pavini Moray,* How to Hold Power: A Somatic Approach to Becoming a Leader *(North Atlantic Books, 2023). Tagged against Group eCoach Tag Register (10 domains / 60 leaves / 22 situations / 6 handoffs).*

---

## Reframe & flags (read first)

**Audience reframe — boss→volunteer leader.** Moray writes for workplace bosses/founders with employees, contracts, and firing power. The Group eCoach serves a *volunteer* leader whose authority is non-positional, earned, and revocable (A1.1). Almost all of the book is inner-game and relational craft, which transfers directly — and arguably *more* cleanly, since a volunteer leader can compel no one and therefore lives or dies on presence and legitimacy. Throughout this summary, "boss/employee" is reframed as "leader/member." Where a claim leans on contractual or positional power (contracts as the consent vehicle, firing), a `Source reach:` line marks it.

**FLAG 1 — embodiment has no register leaf.** The book's load-bearing construct (the body as an information source; felt sense; nervous-system regulation) is a *cross-cutting substrate*, not a domain. Per the agreed decision it is tagged onto its nearest leaves (A1.4, A7.1, A10.2) and flagged here, not given a new code. Candidate for a new leaf or a third cross-cutting lens after tag-testing.

**FLAG 2 — "somatic boundaries" has no precise leaf.** Moray's "boundaries" = a leader's personal limits (saying/hearing no and yes). The register's A5.6 is *group membership* boundaries; A8 is conflict. Tagged to A10.2 (boundaries prevent burnout) + A6.5 (honoring members' boundaries) with this flag.

**Size note.** Summary ≈ 10K words ≈ ~13% of the ~77K-word source — below the nominal floor by design: ~40% of the book is "Practice Moment" exercises (execution), captured here as *why* only per the understanding-not-execution gate, not reproduced. Against the summarizable ~46K words this is ~22%.
...
6. **Observe and name what is**
7. **Be curious**
8. **Envision**
9. **Inspire**
10. **Discern aligned action**
11. **Set boundaries**
12. **Decide**
13. **Take action**
14. **Receive support**
15. **Be with discomfort**

**How a coach uses it:** as a diagnostic and a focus-setter. Ask the leader which capacities feel strong and which feel thin; have them name what their group would say; then pick *one* to build a small, concrete practice around (ch.6's move). Several of these capacities have their own fuller treatment below — *listen* → "Listening as a leadership superpower"; *set boundaries* → "Boundaries: saying and hearing no"; *repair conflict* → "Repair"; *be with discomfort* / *receive support* → "Internal safety and self-compassion."
