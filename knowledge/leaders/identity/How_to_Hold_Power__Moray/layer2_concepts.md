...
# How to Hold Power — ## Layer 2 — Concept Entries


### Leadership is somatic, not positional
...
- **Why it matters / evidence:** A first-time leader who believes authority is automatic will be baffled when members don't follow. Naming that followership is *earned through how you show up* turns "imposter" feelings into a practice agenda rather than a verdict. Moray's own arc — from assuming the title made her a boss to learning she had to "develop the body of a leader" — is the book's organizing testimony.
- **Related concepts:** earned vs unearned power [A1.1] (the kind of authority a volunteer holds); presence [A1.4] (the mechanism of followership); building-and-using-power [A7.1] (what gets exercised once you've stepped in).
- **Source reach:** Strongly backed as the book's thesis; the volunteer-vs-boss translation is ours — Moray's cases are workplace.

### The body as information (the felt sense)
...
- **Why it matters / evidence:** A volunteer leader makes constant fast reads — is this person over-committed, is the room checked out — that no dashboard captures. The felt sense is the instrument, available free and always. **FLAG:** this is the embodiment substrate with no register leaf; tagged to A1.4.
- **Related concepts:** nervous-system regulation [A10.2] (the system the felt sense reads); presence [A1.4] (the attention that tunes it in); boundaries [A10.2] (felt as the "uh-oh" before they're named).
- **Source reach:** Richly backed in the source; no register home for "felt sense" — attribute to the book and flag.
...
- **Why it matters / evidence:** A dysregulated leader transmits dysregulation to the group and burns out; regulation is the precondition for holding power and conflict without harm. **FLAG:** embodiment substrate, tagged to A10.2; the B.B.O.D.Y. *practice* is execution and is not reproduced.
- **Related concepts:** the body as information [A1.4] (what regulation makes readable); de-escalation [A8.1] (regulation applied to conflict); triggers [A1.6] (dysregulation's acute form).
- **Source reach:** Neuroscience framing is the source's (Porges, Siegel); the practice steps are deliberately omitted per the execution gate.

### Contractions and resistance as protection
concepts: [A10.2 leader-self-care] [A1.6 failure-as-learning]
situations:
handoff:
anchors to: The body is information; change is bottom-up
...
- **Why it matters / evidence:** New leaders pathologize their own avoidance and fear. Reframing resistance as protective information defuses shame and converts "I keep failing to follow through" into a question worth asking. This anchors the book's broader stance that setbacks are data, not verdicts [A1.6].
- **Related concepts:** internal safety & self-compassion [A1.6] (the stance that makes "supporting" possible); nervous-system regulation [A10.2] (contraction as a regulation strategy); the body as information [A1.4] (the contraction as a message).
- **Source reach:** Well-supported; the somatic exercises ("support the contraction") are summarized as principle, not prescribed.

### Narratives, the "shoulds," and a growth mindset
...
- **Why it matters / evidence:** First-time leaders often carry a "bosses know everything" should that makes asking, learning, and not-knowing feel like exposure. Naming it as a narrative — changeable — is what unlocks the beginner's stance leadership actually requires.
- **Related concepts:** internal safety [A1.6] (so changing a narrative isn't self-attack); leadership is somatic [A1.4] (narratives live in the body); lead-by-example [A1.3] (modeling the growth stance).
- **Source reach:** Solidly the source's model; "growth mindset" is invoked generally, not tied to a specific study.

### Internal safety and self-compassion
concepts: [A1.6 failure-as-learning] [A10.2 leader-self-care]
situations: [S:i-feel-like-an-imposter]
handoff:
anchors to: The body is information; change is bottom-up
source: Moray — *How to Hold Power*, ch.4
...
- **Why it matters / evidence:** A volunteer leader running on self-criticism burns out and leads anxiously. Internal safety is the quiet engine under resilience, honest self-assessment, and the capacity to take feedback. **Note:** keep this strictly about the leader's stance toward themselves; do not turn it into clinical advice.
- **Related concepts:** failure-as-learning [A1.6] (self-compassion is what makes the reframe livable); leader-self-care [A10.2] (sustainability); receiving feedback [A1.6] (needs internal safety to land).
- **Source reach:** IFS and the "eight C's" are the source's framing; we present them lightly, not as a method to administer.

### Presence: how a leader is read
concepts: [A1.4 stepping-into-the-role] [A7.1 building-and-using-power]
situations:
handoff:
anchors to: Leadership is somatic, not positional
...
- **Why it matters / evidence:** Volunteers give discretionary energy to leaders they feel met by. Presence is also the prerequisite for the three-legged stool: you can't listen, hold a boundary, or draw out dissent absent. It is the daily, low-cost practice with the highest leadership return.
- **Related concepts:** listening [A9.6] (presence applied to another); leadership is somatic [A1.4] (presence is the followed quality); culture [A6.1] (presence rehearsed becomes ritual).
- **Source reach:** Fully the source's; the specific rituals are illustrative, not prescriptive.

### What power is — formal vs informal
...
- **Why it matters / evidence:** For an audience often burned by *power-over*, naming that power is multi-sourced and partly *earned* makes responsible authority feel achievable rather than tainted. It also tells a volunteer leader where to invest: relationships and competence, not posturing.
- **Related concepts:** four ways of using power [A7.1] (what you do with it); earned vs unearned power [A1.1] (the earned/privilege split); leadership is somatic [A1.4] (feeling the power you hold).
- **Source reach:** Definitions credited (Kashtan; Starhawk elsewhere); the typology is the source's synthesis.

### Four ways of using power: over, under, with, within
...
- **Why it matters / evidence:** This is the heart of the coach's value for leaders who *experienced* power-over and fear becoming it. The framework gives them a non-tyrannical template and names the gossip/sabotage pattern (power-under) they'll meet when others feel dominated.
- **Related concepts:** flattening power [A7.1] (the well-meant failure mode of power-with); autonomy-vs-direction [A7.3] (power-with still steers); retaliation [A8.1] (revenge as power-over).
- **Source reach:** The four-power frame is Starhawk's, credited; examples are the source's composites.

### Flattening power (the false-equality trap)
concepts: [A7.1 building-and-using-power] [A7.3 autonomy-vs-direction] [A1.5 fear-of-asking-or-delegating]
...
- **Why it matters / evidence:** Volunteer leaders, often allergic to hierarchy, are *especially* prone to flattening — and to the cousin failure of not delegating because asking feels like imposing [A1.5]. Naming flattening lets them hold "just enough" authority [A7.6] honestly while genuinely sharing it.
- **Related concepts:** four ways of using power [A7.1] (power-with done wrong); hierarchy-just-enough [A7.6] (the calibrated alternative); fear-of-asking-or-delegating [A1.5] (the adjacent over-correction).
- **Source reach:** Strongly the source's; the anonymous quotation is the book's, used here in paraphrase.

### Power leaks and reclaiming power
concepts: [A7.1 building-and-using-power] [A1.4 stepping-into-the-role]
situations:
handoff:
anchors to: Power is neutral; how you hold it is everything
source: Moray — *How to Hold Power*, ch.5
...
- **Why it matters / evidence:** New leaders often blame circumstances or others when momentum stalls — a leak that compounds. Naming blame/denial/minimizing as *power loss* reframes accountability as self-interest, not self-flagellation.
- **Related concepts:** four ways of using power [A7.1] (leaks undercut power-within); the body as information [A1.4] (the felt cue of a leak); failure-as-learning [A1.6] (catching leaks without self-attack).
- **Source reach:** Source-backed; the "quick power fix" posture cue is summarized, not prescribed as the answer.

### Earned vs unearned power (privilege)
...
- **Why it matters / evidence:** A volunteer group spans identities and unequal social power. A leader who can feel and name this leads more justly and avoids the entitlement that quietly alienates members. This anchors what "earned, consent-based authority" (A1.1) actually means for the volunteer context.
- **Related concepts:** what power is [A7.1] (systemic/majority power as unearned types); leadership is somatic [A1.4] (feeling the difference); power-with [A7.1] (the respectful response to a differential).
- **Source reach:** Fully the source's, including its social-justice framing; present as the author's lens, attributed.

### Triggers and trauma-informed leadership
concepts: [A10.2 leader-self-care] [A1.6 failure-as-learning]
situations: [S:burning-out]
handoff:
anchors to: The body is information; change is bottom-up
...
- **Why it matters / evidence:** ~70% of US adults report a traumatic event (National Council for Behavioral Health), so triggers will show up in any group. A leader who can self-regulate prevents reactive damage and models repair. **Sensitive-topic note:** trauma is referenced as leadership context; this is not clinical guidance — point users to professionals for trauma processing.
- **Related concepts:** nervous-system regulation [A10.2] (the skill that handles a trigger); co-regulation [A8.1] (triggers in the group); failure-as-learning [A1.6] (triggers as information, not shame).
- **Source reach:** Trauma framing credited (Levine, Frankl); the four-step trigger practice is summarized as principle, not walked through.

### Co-regulation: the bigger nervous system in the room
concepts: [A8.1 task-vs-relationship-conflict] [A6.5 psychological-safety] [A10.2 leader-self-care]
...
- **Why it matters / evidence:** In volunteer groups, conflict and overwhelm have nowhere formal to go; the leader's regulation is often the only container. Naming co-regulation gives a first-timer a concrete, non-confrontational move for tense moments and dominating or distressed members.
- **Related concepts:** nervous-system regulation [A10.2] (the leader's own settling); de-escalation [A8.1] (co-regulation in active conflict); psychological-safety [A6.5] (the felt result for members).
- **Source reach:** Source-backed; "bigger nervous system" is the book's phrase, applied here to volunteer groups.

### Boundaries: saying and hearing no (and yes)
concepts: [A10.2 leader-self-care] [A6.5 psychological-safety]
...
- **Why it matters / evidence:** Volunteer leaders who can't say no over-function into burnout; those who can't hear no can't build consent. **FLAG:** no register leaf for personal boundaries — tagged A10.2 (burnout prevention) + A6.5 (honoring others'). **Source reach:** the workplace "contract" framing for boundaries doesn't transfer; the personal-limits craft does.
- **Related concepts:** consent culture [A6.5] (boundaries are its precondition); a culture of requests [A1.5] (asking while okay with no); leader-self-care [A10.2] (boundaries prevent burnout).

### A culture of consent
concepts: [A6.5 psychological-safety] [A7.2 decisions-as-shared-process] [A3.2 ownership-and-voice]
...
- **Why it matters / evidence:** Volunteers especially over-commit and then quietly flake; a consent culture surfaces the real yes up front, reducing flakiness and resentment. **Source reach:** the contract-as-consent-vehicle is workplace-specific; the *culture* of safe refusal transfers directly to volunteers.
- **Related concepts:** drawing out dissent [A8.2] (how you reach real consent); boundaries [A10.2] (its precondition); ownership-and-voice [A3.2] (consent produces buy-in).
...
- **Why it matters / evidence:** "Everyone just agrees" is a danger sign, not harmony — it usually means dissent has gone underground and will resurface as flaking or attrition. Drawing it out is the antidote to false consensus and the groupthink the register flags at A8.2/A6.5.
- **Related concepts:** consent culture [A6.5] (dissent is the route to it); listening [A9.6] (clarifying questions draw dissent out); decisions-as-shared-process [A7.2] (dissent improves decisions).
- **Source reach:** Strongly source-backed; an explicit anti-groupthink leaf-fit.

### A culture of requests (demand vs request)
concepts: [A1.5 fear-of-asking-or-delegating] [A9.2 delegating-outcomes-not-tasks]
...
- **Why it matters / evidence:** First-time leaders frequently do everything themselves because asking feels like imposing [A1.5]. Reframing the ask as a request they're allowed to refuse lowers the fear *and* models the consent culture — and is the on-ramp to real delegation [A9.2].
- **Related concepts:** fear-of-asking-or-delegating [A1.5] (the block this dissolves); delegating-outcomes [A9.2] (requests are how you hand off); transactional-vs-relational-ask [A3.3, lens] (request vs extraction).
- **Source reach:** NVC framing credited; the request *format* is method but stated as principle, not a script library (deep how-to → comms/recruitment coaches).

### Listening as a leadership superpower
concepts: [A9.6 coaching-group-members] [A6.5 psychological-safety]
situations:
handoff:
anchors to: Boundaries, consent, listening — the three-legged stool
...
- **Why it matters / evidence:** Feeling heard is the near-universal need members bring; it's the cheapest, highest-yield tool a volunteer leader has for retention and for coaching people toward ownership. **Source reach:** fully the source's; "20%" is the author's rule of thumb, not a study.
- **Related concepts:** allowability of feeling [A6.5] (its de-escalation engine); belonging [A6.3] (listening creates it); coaching-group-members [A9.6] (listening is how you develop people).

### Belonging as the driver of staying
concepts: [A6.3 cohesion-and-belonging] [A2.4 group-identity-and-belonging] [A10.6 satisfaction-and-retention]
...
- **Why it matters / evidence:** Newcomers who don't stick and low attendance are usually belonging failures, not logistics failures. For volunteers, who can leave costlessly, belonging is the retention engine the register names at A10.6.
- **Related concepts:** listening [A9.6] (the mechanism of belonging); onboarding-newcomers [A9.7] (belonging at entry); satisfaction-and-retention [A10.6] (the outcome).
- **Source reach:** Source-backed; presented as the author's experience and counsel, not measured effect sizes.

### Receiving feedback (mine the nugget of truth)
concepts: [A1.6 failure-as-learning] [A9.6 coaching-group-members]
situations:
handoff:
anchors to: The body is information; change is bottom-up
source: Moray — *How to Hold Power*, ch.10
...
- **Why it matters / evidence:** Volunteer leaders get unfiltered, emotionally loaded feedback and no HR buffer. The skill of metabolizing it — keep the nugget, release the projection — protects both their resilience [A1.6] and the member's sense of being heard, which is itself developmental [A9.6].
- **Related concepts:** internal safety [A1.6] (so feedback doesn't shatter you); listening [A9.6] (feedback is listening under load); repair [A8.5] (acting on the nugget).
- **Source reach:** Fully the source's; "projection" used colloquially, not clinically.

### Generative conflict and the ethical fighter
...
- **Why it matters / evidence:** Volunteer groups often suppress conflict until it explodes or someone quits (see Lou and Jen). Naming conflict as generative — and giving a code of conduct for it — lets a first-timer stay in hard conversations instead of avoiding them into rupture.
- **Related concepts:** drawing out dissent [A8.2] (conflict's quieter cousin); de-escalation [A8.1] (when it heats up); repair [A8.5] (what makes conflict generative).
- **Source reach:** Source-backed; "generative conflict" and the rules of engagement are the author's framing.

### Retaliation: clean pain vs dirty pain
concepts: [A8.1 task-vs-relationship-conflict] [A7.1 building-and-using-power]
...
- **Why it matters / evidence:** Leaders who were on the receiving end of power-over may carry a strong impulse to even scores once they hold power. Naming retaliation as power-over, and offering the clean/dirty pain frame, gives them a way to break the cycle rather than reproduce it.
- **Related concepts:** four ways of using power [A7.1] (retaliation = power-over); generative conflict [A8.1] (the alternative path); repair [A8.5] (what you do instead).
- **Source reach:** Clean/dirty pain credited to Menakem; presented as his distinction, lightly.

### De-escalation and the time-out
concepts: [A8.1 task-vs-relationship-conflict] [A10.2 leader-self-care]
...
- **Why it matters / evidence:** Volunteer disputes have no manager to separate parties; the leader's ability to call and use a clean time-out is often the only brake. It models self-responsibility and keeps conflict from turning personal.
- **Related concepts:** co-regulation [A8.1] (the spiral a time-out interrupts); nervous-system regulation [A10.2] (what you do on the break); repair [A8.5] (what follows once calm).
- **Source reach:** Source-backed; the five steps are summarized as principle, not reproduced as a procedure.

### Repair: the technologies of coming back
concepts: [A8.5 repair-and-mutual-accountability] [A8.1 task-vs-relationship-conflict]
situations: [S:two-members-clashing] [S:conflict-got-personal]
handoff:
anchors to: Conflict is generative; repair builds the trust
source: Moray — *How to Hold Power*, ch.11
...
- **Why it matters / evidence:** Repair is where conflict becomes generative — and it's the rarest skill, so a volunteer leader who can do it stands out and holds groups together through rupture. **Sensitive note:** Moray brackets egregious harm (e.g., harassment) as out of scope and routes to professional support — preserve that boundary.
- **Related concepts:** generative conflict [A8.1] (repair is what makes it generative); receiving feedback [A1.6] (acknowledging impact under load); peer-accountability [A8.3] (repair among equals).
- **Source reach:** Owning-contributions credited (Harvard Negotiation Project); the technologies are summarized as principle, not scripted.

### Creating a culture of embodied humanity
concepts: [A6.1 how-norms-form-and-become-culture] [A6.5 psychological-safety] [A1.3 lead-by-example]
situations: [S:group-feels-transactional]
handoff: [H:org-level]
anchors to: Leadership is somatic, not positional
...
- **Why it matters / evidence:** A volunteer group's culture is its retention and effectiveness substrate; a first-time leader needs to see that culture is built through their own repeated embodiment, not announced. **Boundary:** designing an *organization-wide* embodied culture is flagged by Moray as beyond the book's scope — route org/program-level culture design to **H:org-level**; keep this entry at the leader's own group.
- **Related concepts:** lead-by-example [A1.3] (the mechanism); psychological-safety [A6.5] (the felt result); presence [A1.4] (the daily practice that compounds).
- **Source reach:** Source explicitly stops at the single leader/group; org-level culture is out of scope and routed out.

---


<!-- SEARCH_TERMS
moray — how to hold power | how to hold power
domains: A1 | A7 | A8 | A10
leaves: A1.1 A1.3 A1.4 A1.5 A1.6 A10.2 A10.6 A2.4 A3.2 A3.3 A6.1 A6.3 A6.5 A7.1 A7.2 A7.3 A7.6 A8.1 A8.2 A8.3 A8.5 A9.2 A9.6 A9.7
keywords: identity | stepping-into-leadership | leading-without-authority | imposter | power | decisions | autonomy | autonomy-model | distributed-leadership | conflict | dissent | accountability | repair | difficult-conversations | sustaining | burnout | self-care | recognition | resilience | wellbeing
situations: burning-out cant-make-decisions conflict-got-personal doing-everything-myself everyone-just-agrees group-feels-transactional i-cant-let-go i-feel-like-an-imposter low-attendance newcomers-dont-stick one-person-dominates scared-to-ask-people two-members-clashing volunteers-flaky
-->