...
# Source Summary — *Handbook of Leadership Theory and Practice* (Nohria & Khurana, eds.)

**product:** Group Leader eCoach · **doc:** `_RAGSRC__Handbook_of_Leadership_Theory_and_Practice__Nohria_Khurana_eds__Source_Summary` · **owner:** [you] · **review:** Instruction Set A · **version:** 1.0 · **date:** 2026-06-07

*Edited volume, not a single argument. Summarized from in-scope chapters only (4, 6, 15, 17, 18, 21, 22, 25), each entry chapter-attributed. Org/CEO-altitude chapters and corpus-overlap chapters excluded — see end. Tagged against the Group eCoach Tag Register. Quotes are verbatim, one per chapter maximum, each under 15 words.*
...
source: Chatman & Kennedy — *Handbook* ch.6; Avolio — *Handbook* ch.25
governs: [A1.4] [A1.6] [A9.1]

**Diagnose, then flex.** The core skill is reading a situation accurately and varying your response to fit it — while staying recognisably consistent. Three capabilities: diagnostic ability, a broad behavioural repertoire, and unambiguous signalling. Flexibility risks looking erratic, so it must rest on consistent values.
flagship example: The trap Chatman & Kennedy name is the narrow "dominant response" — falling back on one style under stress — fine for a specialist, disabling for a leader facing varied situations. Lorsch sharpens one axis: directive when the task is certain, participative when it is uncertain.
source: Chatman & Kennedy — *Handbook* ch.6 (with Lorsch — ch.15)
governs: [A7.3] [A1.4] [A8.1]
