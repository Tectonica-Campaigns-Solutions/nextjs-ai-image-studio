...
# _RAGSRC__ People, Power, Change (Ganz) — Source Summary for the Group eCoach RAG

**Source:** Marshall Ganz, *People, Power, Change: Organizing for Democratic Renewal* (Oxford University Press, 2024)
...
**Coverage note — read first:** Unlike Burns (a grand-scale, foundational source sized far below the band), Ganz is a *coverage* source written for almost exactly our audience — a first-timer learning to lead and develop people in a small group. Most of the book passes both gates, so this summary runs in the upper half of the band (~20% of source). Two scope decisions shape it. (1) **Chapter 4 (Strategizing) is kept, at the leader's altitude** — local group leaders do set theories of change, strategic goals, and tactics for their own turf — but its campaign-operations machinery (national field structures, the long UFW campaign retold as a worked example) is compressed to the transferable principle. (2) **Chapter 6 (Structure) is split:** the leader-level half (bounding your own team, norms, distributing responsibility, dissent-is-not-disloyalty, meet/act/celebrate) is kept deep; the org-level half (firms-vs-associations, federated/parts-and-wholes structure, the iron law of oligarchy, the mobilizing-vs-organizing *campaign architecture*) gets a light orienting note and routes to `H:org-level`.

**Register-gap flag — strategy has no Axis A home.** The register has no Strategy domain. Ganz's strategy concepts (theory of change, power map, strategic goal, tactics, timing) are tagged here against their nearest leaves — mostly **A7.1** (power/resourcefulness), **A2.1** (who-are-my-people / change-they-want), **A5.1** (strategic capacity of a diverse team), **A7.2/A7.3** (deciding / forest-and-trees). No codes were invented. This is the strongest case in the corpus so far for adding a strategy leaf (or domain); marking it rather than forcing it. One consequence: **A7 carries the heaviest entry load in this doc** — genuine, not padding, since power + strategy + decisions all currently live there.

**Standing Source-reach caveat (applies doc-wide):** Ganz's flagship cases are often large — the UFW grape boycott, the 2008 Obama field campaign, the Montgomery Bus Boycott, Moses. The *principle* transfers to a 3–7-person volunteer group; the *scale of the illustration* usually does not, and entries say so. Where Ganz offers a genuinely small-group case — the leadership-team launch, the Molly/Ashley phone bank, Fred Ross coaching Larry Tramutola, the one-sentence shared-purpose exercise — it is used as the flagship.
