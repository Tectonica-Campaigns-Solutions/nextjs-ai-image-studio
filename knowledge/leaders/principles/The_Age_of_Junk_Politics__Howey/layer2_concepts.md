---
title: "The Age of Junk Politics"
source: "Howey — The Age of Junk Politics"
domains: [A2, A3, A4]
...
# The Age of Junk Politics — ## Layer 2 — Concept Entries


### Transactional vs. transformational, in how you treat your people
...
- **Why it matters / evidence:** A volunteer leader who only ever makes transactional asks builds a group that behaves transactionally — people show up for the discrete thing and drift when it ends. The lens reframes "my group feels transactional" from a mood problem into a design choice the leader can change by adding participation, voice, and relationship [A3.2][A4.1]. This is the cross-cutting lens the register anchors here.
- **Related concepts:** transactional-vs-relational-ask [A3.3] (the ask is where the mode shows); ownership-and-voice [A3.2] (the transformational alternative in practice); commitment-over-time [A3.4] (why the modes diverge in durability).

### The relational ask vs. the extractive ask
...
- **Why it matters / evidence:** A small group lives or dies on its asks. If every ask is extractive, the group feels transactional and people give the minimum; if asks are relational, the same request can deepen commitment. The book's organizing-versus-mobilizing throughline supports this: extraction scales numbers, relationship scales depth — and depth is what keeps a volunteer group alive [A3.4].
- **Related concepts:** transformational-vs-transactional [A2.5] (the mode the ask expresses); relationships-are-strategy [A4.1] (the ground a relational ask stands on); fear-of-asking-or-delegating [A1.5] (the reframe that unblocks the timid asker). *Note: tactical ask mechanics / the escalation ladder route to* **H:recruitment** *[A3.5].*

### Mobilizing vs. organizing — and why even canvassing can transform
concepts:   [A2.5 transformational-vs-transactional]
situations:
handoff:    H:events
anchors to: Transformation vs. transaction
...
- **Why it matters / evidence:** A group leader running door-knocks, phone banks, or events should know the *why-level* lesson — that connection, not message delivery, is where the value lives — even though the how-to of running canvasses belongs to the events coach. Treating a mobilizing task as a relational opportunity is the difference between a fleshier advertisement and a transformative encounter.
- **Related concepts:** relationships-are-strategy [A4.1] (the medium that makes canvassing transform); group-identity-and-belonging [A2.4] (what the encounter shifts); developing-leaders [A9.1] (the organizing aim). *Canvassing logistics, routes, scripts →* **H:events** */* **H:comms**.

### People form beliefs by taking part
concepts:   [A3.2 ownership-and-voice] [A3.4 commitment-over-time]
...
- **Why it matters / evidence:** "No one takes initiative" is often a participation-design problem, not an apathy problem: people who are only asked for tasks never get the voice that would make them owners. Giving real ownership is how a leader converts attendees into initiators. Howey reinforces it with the older activist's "it changed us" — the deepest commitments are forged by participating, win or lose.
- **Related concepts:** intrinsic-motivation [A3.1] (agency/autonomy as the driver); group-identity-and-belonging [A2.4] (where belief actually lives); developing-leaders [A9.1] (participation is the on-ramp to leadership).

### You can't change people — you open the way
...
- **Why it matters / evidence:** A first-time leader often over-functions — trying to motivate, persuade, and fix people directly — and burns out [A10.2] while the group stays passive. "Open the way" relocates the leverage to designing participation and stepping back [A1.2], which is both more effective and more sustainable.
- **Related concepts:** autonomy-vs-direction [A7.3] (agency must be left intact); enabling-vs-doing [A1.2] (facilitate rather than perform); coaching-group-members [A9.6] (the teacher stance).

### The two engines: participation (doing) and human contact (the other)
concepts:   [A3.1 intrinsic-motivation] [A2.4 group-identity-and-belonging]
situations:
handoff:
...
- **Why it matters / evidence:** It gives a leader a concrete design test for any activity: does this give people something real to *do*, and does it put them in genuine *contact* with others? Solo busywork fails both; a connected, agentic task passes both — which is why small-group work, done relationally, punches above its size.
- **Related concepts:** ownership-and-voice [A3.2] (the participation engine); cohesion-and-belonging [A6.3] (the contact engine's payoff); relationships-are-strategy [A4.1] (contact as the medium).

### Relationships are the material of the work
...
- **Why it matters / evidence:** Low attendance and a transactional feel are frequently relationship deficits in disguise — people don't show up for tasks, they show up for people and purpose. The leader's highest-leverage investment is the web of ties in and around the group, not the perfect message or the fuller task list [A4.4].
- **Related concepts:** group-identity-and-belonging [A2.4] (the felt "we" relationships create); trust-building [A4.3] (what relationships deposit); the-1:1-relational-meeting [A4.2] (the practice that builds them).

### Belonging is primary to belief
...
- **Why it matters / evidence:** "Newcomers don't stick" is often a belonging failure: people came for the cause but found no "we" to join. Cohesion here is understood as a *result* of connecting and cooperating, so the leader builds it by creating shared experience and acceptance, not by demanding loyalty up front [A6.3].
- **Related concepts:** cohesion-and-belonging [A6.3] (belonging as an outcome of doing together); relationships-are-strategy [A4.1] (the ties that carry belonging); onboarding-newcomers [A9.7] (where belonging is won or lost). *Source reach: the Organising Equation is a Tectonica framework presented as a list of factors, not independently evidenced here; attribute as Tectonica's model and name belonging's primacy as Howey's claim rather than a proven effect size.*

### Get personal: depth over reach
concepts:   [A4.1 relationships-are-strategy] [A4.2 the-1:1-relational-meeting]
situations:
handoff:
anchors to: Belonging is primary to belief
...
- **Why it matters / evidence:** A volunteer leader has scarce time and will be tempted to "reach more people" through cheap channels. This says the opposite is usually right: invest in the small number of real, personal contacts (the 1:1) that actually build relationship and move people [A4.2]. Depth is the strategy, not a consolation for lacking scale.
- **Related concepts:** the-1:1-relational-meeting [A4.2] (the most personal contact there is); relationships-are-strategy [A4.1] (why personal wins); transactional-vs-relational-ask [A3.3] (impersonal blasting is the extractive ask). *Source reach: the Gerber & Green result is specific to GOTV; Howey generalizes it by observation, so attribute the broader claim as his extension, not as established finding.*

### Be human: speak from the self (public narrative)
...
- **Why it matters / evidence:** New leaders often think authority comes from mastering facts; this says it comes from being human and inviting others to be. Teaching members to find and tell their story of self is a concrete, learnable practice that deepens both connection and commitment.
- **Related concepts:** shared-purpose / why-before-what [A2.1] (the "story of us/now" carries the why); group-identity-and-belonging [A2.4] (story is how identity is shared); trust-building [A4.3] (vulnerability of self-disclosure builds trust). *Source reach: the book only names the three-part structure, it doesn't teach it; attribute Public Narrative to Ganz and recommend his work for the actual method.*

### Go local: ground the why in people's lives
...
- **Why it matters / evidence:** It tells a leader to trust and deploy members' local knowledge rather than handing down a uniform script — the volunteer from the neighborhood is the asset. The principle also guards against the alienation that comes when outsiders speak over a community they don't understand.
- **Related concepts:** public-narrative [A2.2] (the local "story of us"); cross-cutting-ties-before-conflict [A4.6] (belonging to the community earns the hearing); relationships-are-strategy [A4.1]. *Note: shades into message localization, which routes to* **H:comms**.

### Shared purpose as the underlying driver
concepts:   [A2.1 shared-purpose / why-before-what] [A2.3 values-as-glue]
...
- **Why it matters / evidence:** "The group lost its why" is one of the most common stalls, and it's usually that purpose went unspoken while tasks took over [A6.4]. Re-anchoring on shared purpose is the corrective — cheaper and more powerful than any new tactic, and the condition under which all the relational work coheres.
- **Related concepts:** values-as-glue [A2.3] (purpose expressed as shared values); group-identity-and-belonging [A2.4] (purpose binds the "we"); transformational-vs-transactional [A2.5] (purpose is what makes the transformational mode possible).

### Hope, and the leader as a symbol of collective values
...
- **Why it matters / evidence:** A volunteer group running on grim duty erodes; one carrying hope and small symbolic wins sustains itself through setbacks [A10.5][A10.3]. The leader who names what's possible and marks progress is doing motivational work, not spin.
- **Related concepts:** resilience-through-setbacks [A10.5] (hope is what holds a group through losses); celebration-and-recognition [A10.3] (symbolic wins feed hope); shared-purpose [A2.1] (hope attaches to the why). *Source reach: hope and symbolism are itemized in Tectonica's Organising Equation rather than independently evidenced; attribute as the model's factors and Howey's argument, not measured effects.*

### Power-with, not power-over (acompañar)
...
- **Why it matters / evidence:** "I'm doing everything myself" is often a power-over reflex — keeping control feels safer and faster — but it caps the group at the leader's own capacity and starves others of agency. Power-with is the structural cure: share real power and the group's total capacity grows, while authority becomes legitimacy granted by members rather than position [A1.1].
- **Related concepts:** autonomy-vs-direction [A7.3] (power-with leaves agency intact); enabling-vs-doing [A1.2] (the facilitator role); developing-leaders [A9.1] (power-with is how leaders multiply).
...
- **Why it matters / evidence:** "Doing everything myself" and "no one takes initiative" are the same problem from two angles: leadership hasn't been built or distributed. The fix is to consciously identify and grow leaders and spread leadership functions, so the group stops bottlenecking on one person [A9.3] and gains capacity.
- **Related concepts:** functional-shared-leadership [A9.5] (leadership as functions, not a title); avoiding-founder-bottleneck [A9.3] (what building leaders prevents); coaching-group-members [A9.6] (how you grow them).

### Capacity is built experientially, not in a training
...
- **Why it matters / evidence:** A first-time leader often equates development with an onboarding session. This reframes it: the development happens in the doing and the debrief. Building in reflection after activity is the cheap, high-yield practice that turns members into capable, adaptive contributors and future leaders.
- **Related concepts:** learning-together [A6.6] (reflection/debrief as the engine); developing-leaders [A9.1] (the outcome capacity-building serves); onboarding-newcomers [A9.7] (capacity begins, but doesn't end, at entry).

### Decentralize decisions so leadership can grow
concepts:   [A7.3 autonomy-vs-direction] [A9.1 developing-leaders]
...
- **Why it matters / evidence:** "I can't let go" caps a group at the leader and keeps members from ever becoming leaders. Decentralizing decisions is the concrete act that breaks the bottleneck and develops people. *The design of cross-group / program-wide autonomy structures (e.g. distributed-organizing models, the 5-level autonomy framework) is an org-level call and routes to* **H:org-level** *[A7.4]; what's leader-facing here is the principle of ceding decisions within your own group.*
- **Related concepts:** autonomy-vs-direction [A7.3] (hold the what, free the how); avoiding-founder-bottleneck [A9.3] (what ceding decisions cures); functional-shared-leadership [A9.5].

### Listen up the chain: members as community intelligence
...
- **Why it matters / evidence:** It gives a leader a reason to institute regular debriefs beyond skill-building: the group learns about its world through its members, and members feel heard (deepening commitment). *Note: how this feeds organizational strategy/messaging is an org-level concern →* **H:org-level**; *the leader-facing practice is simply to listen to and learn from your people.*
- **Related concepts:** coaching-group-members [A9.6] (the debrief that surfaces it); decisions-as-shared-process [A7.2] (members' intelligence informs decisions); ownership-and-voice [A3.2] (being listened to is itself voice).

### Transformation takes time, patience, and love
concepts:   [A3.4 commitment-over-time] [A6.2 stages-and-development]
situations:
handoff:
anchors to: People form beliefs by taking part
...
- **Why it matters / evidence:** New leaders often expect quick commitment and read slow uptake as failure, then bail on the relational work just before it pays. This sets the right expectation — and protects the leader from the burnout of pushing for fast results [A10.1] — by framing patience and care as the method, not a lack of one.
- **Related concepts:** commitment-over-time [A3.4] (the lagged build of commitment); stages-and-development [A6.2] (groups move through phases); resilience-through-setbacks [A10.5] (patience through losses).

### Pay can crowd out purpose (the paid-helper caution)
...
- **Why it matters / evidence:** Volunteer groups occasionally pay stipends or hire help; this flags that money changes the motivational mix and should be paired with purpose-alignment, not assumed neutral. It's the money-and-motivation boundary condition stated plainly for a first-timer.
- **Related concepts:** intrinsic-motivation [A3.1] (what pay can crowd out); transactional-vs-relational-ask [A3.3] (pay as a transactional driver); shared-purpose [A2.1] (the alignment to screen for). *Source reach: the book treats this as a practitioner caution, not a study; attribute as Howey's recommendation, and note research on crowding-out lives in the Pink summary [A3.1/A3.6].*

### The transactional campaign paradigm (orienting note)
concepts:   [A2.5 transformational-vs-transactional]
situations:
handoff:    H:org-level
anchors to: Transformation vs. transaction
...
- **Related concepts:** transactional-vs-relational-ask [A3.3] (the resource-model failure at human scale); relationships-are-strategy [A4.1] (what the paradigm omits); transformational-vs-transactional [A2.5].

### Junk politics: market forces shape civic culture (orienting note)
concepts:   [A2.5 transformational-vs-transactional]
situations:
handoff:    H:org-level
anchors to: Transformation vs. transaction
...
- **Related concepts:** transformational-vs-transactional [A2.5] (the cure for junk politics); belonging is primary to belief (what the culture starves); relationships-are-strategy [A4.1].

---


<!-- SEARCH_TERMS
howey — the age of junk politics | the age of junk politics
domains: A2 | A3 | A4
leaves: A1.1 A1.2 A1.5 A10.1 A10.2 A10.3 A10.5 A2.1 A2.2 A2.3 A2.4 A2.5 A3.1 A3.2 A3.3 A3.4 A3.5 A3.6 A4.1 A4.2 A4.3 A4.4 A4.6 A6.2 A6.3 A6.4 A6.6 A7.1 A7.2 A7.3 A7.4 A7.6 A9.1 A9.3 A9.5 A9.6 A9.7
...
situations: doing-everything-myself group-feels-transactional group-lost-its-why i-cant-let-go low-attendance newcomers-dont-stick no-one-takes-initiative scared-to-ask-people
-->