...
# Undivided — ## Layer 2 — Concept Entries


### Belonging before belief (heart before head)
concepts:    [A2.4 group-identity-and-belonging] [A2.1 shared-purpose]
...
- **Why it matters / evidence:** A first-time leader who waits for buy-in before offering belonging will lose people at the door. Han's seven-year study found the durable participants were the ones who first found a "we" — a sense of acceptance — and only then took on the work; the program's own data showed transformation was gradual and relational, never a single conversion moment.
- **Related concepts:** trust-building [A4.3] (belonging is built through accumulated small risks); relational-vs-transactional [A3.3] (belonging is the felt result of a relationship, not a transaction); shared-purpose [A2.1] (the "why" lands only once people feel they belong).

### People change through experience and relationship, not information
concepts:    [A6.6 learning-together] [A2.4 group-identity-and-belonging]
...
- **Why it matters / evidence:** This is why a leader should favor doing-and-debriefing over presenting. Han points to the documented weakness of pure information/awareness programs (a review of 400+ prejudice-reduction experiments found the evidence too weak for actionable recommendations) against the strength of experience metabolized inside trusted relationships.
- **Related concepts:** psychological-safety [A6.5] (people only risk the experience when it feels safe enough); the-relationship-web [A4.4] (change spreads through trusted networks); learning-together [A6.6] (joint sense-making is the engine).
- **Source reach:** The book's evidence is about attitude/behavior change in an antiracism setting; the coach should present the transferable kernel — *experience + joint meaning-making beats information* — and attribute the specific research claims to Han's cited studies, not state them as general law.

### Safe doesn't mean comfortable: productive discomfort
...
- **Why it matters / evidence:** A first-timer often reads any discomfort as a failure of the group. Han's account shows the opposite — the groups that achieved real belonging were the ones that let people be clumsy and uncomfortable inside a frame of acceptance; the groups that stayed merely cordial never built the trust to do anything hard together.
- **Related concepts:** trust-building [A4.3] (safety is the precondition for the small risks that build trust); productive-dissent [A8.2] (safe-not-comfortable is what lets disagreement surface); cohesion-and-belonging [A6.3] (acceptance after a misstep is what cohesion feels like).

### Relationships are what sustain people through costly work
concepts:    [A4.1 relationships-are-strategy] [A10.5 resilience-through-setbacks]
...
- **Why it matters / evidence:** This is the corpus's clearest statement of *relationships-as-retention*. Warren's finding generalizes the pattern; the book illustrates it repeatedly — the people who made themselves *more* accountable to others persisted, while those who stayed isolated (reading, donating, "patting themselves on the back") drifted off.
- **Related concepts:** cross-cutting-ties-before-conflict [A4.6] (the sustaining ties are often across difference); peer-accountability-without-authority [A8.3] (not letting people down is the accountability mechanism); volunteer-burnout [A10.1] (isolation accelerates dropout; relationship buffers it).
- **Source reach:** *Prisms of the People* carries the broader "relationships are the medium" claim at depth — cross-reference it. Undivided's distinct contribution is narrower and sharper: relationships as the **differentiator under cost/backlash**, which Prisms does not foreground.

### Bridging across difference, not just bonding within
concepts:    [A4.6 cross-cutting-ties-before-conflict] [A4.1 relationships-are-strategy]
...
- **Why it matters / evidence:** For a first-time leader, this reframes diversity from a value statement into a working mechanism: the cross-cutting tie is the load-bearing one. Han's cases show these bridges repeatedly outperforming in-group bonds for keeping people committed when the work got hard.
- **Related concepts:** composition-and-skills [A5.1] (you build bridges by composing for them); trust-building [A4.3] (bridges are built risk by risk); relationships-are-strategy [A4.1] (the bridge does strategic work).
- **Source reach:** *Prisms* makes the bonding-vs-bridging point briefly; Undivided is the corpus's richest illustration of it. Cross-reference Prisms for the "don't go insular" caution; use Undivided for the texture.

### Trust accrues through small reciprocal risks
...
- **Why it matters / evidence:** For a first-timer anxious that their group "isn't close yet," this reframes trust as something built in increments, not events. Han notes some groups never got there and some took weeks — the variable was whether early small risks were reciprocated and rewarded, not any single dramatic exercise.
- **Related concepts:** psychological-safety [A6.5] (safety is what makes the small risk thinkable); cohesion-and-belonging [A6.3] (accumulated reciprocity *is* cohesion); group-identity-and-belonging [A2.4] (repeated reciprocation produces the felt "us").

### Relationship, not transaction: the gift exchange
concepts:    [A3.3 transactional-vs-relational-ask] [A4.1 relationships-are-strategy] [A2.4 group-identity-and-belonging]
situations:  [S:group-feels-transactional]
handoff:
anchors to:  Belonging before belief
...
- **Why it matters / evidence:** A first-time leader often unintentionally makes the group transactional — tracking who did what, making belonging conditional on contribution. Han's account shows the relational/gift mode is what produces the commitment a leader actually wants; the transactional mode produces compliance at best.
- **Related concepts:** relationships-are-strategy [A4.1] (the gift relationship does the strategic work); the-ask [A3.5] (a relational ask is rooted in this mode); transformational-vs-transactional [A2.5] (the same lens at the group's level).

### The one-to-one: the individual meeting
...
- **Why it matters / evidence:** A first-timer's instinct is to recruit by announcement; Han shows the durable base is built through individual relationship. The contrast is explicit elsewhere in the book — broadcast air-game reach is not power (see "spark vs. sustained vehicle"); the ground game of one-on-one relationship is.
- **Related concepts:** trust-building [A4.3] (the 1:1 is where trust starts); relationships-are-strategy [A4.1] (the meeting is strategic, not social); recruiting-as-relational [A4.5] (the 1:1 is recruitment understood as relationship).
- **Source reach:** Han names the practice and its purpose but gives no how-to. The *mechanics* of individual meetings belong to the recruitment coach via H:recruitment; this entry keeps only the understanding of why the 1:1 is foundational.

### From extrinsic to intrinsic: making the work theirs
...
- **Why it matters / evidence:** A first-time leader leaning on guilt or obligation gets flaky, resentful participation. Han's account, consistent with the self-determination research the corpus draws from elsewhere, shows the durable participants were those for whom the work became intrinsically theirs.
- **Related concepts:** ownership-and-voice [A3.2] (people own what they help shape); autonomy-vs-direction [A7.3] (ownership requires real autonomy); commitment-over-time [A3.4] (intrinsic motivation is what makes commitment durable).
- **Source reach:** Pink's *Drive* carries the autonomy/mastery/purpose mechanism at full depth — cross-reference it. Undivided's contribution is the demonstration *in vivo* that the extrinsic→intrinsic shift is what separates lasting from performative commitment.

### Freedom to choose over compliance
concepts:    [A3.2 ownership-and-voice] [A7.3 autonomy-vs-direction]
...
- **Why it matters / evidence:** First-time leaders often equate control with effectiveness and try to require participation. Han's account shows the opposite: the freedom that lets some opt out is the same freedom that lets others fully own the work. Directing the *what* while leaving autonomy on the *how* is the balance.
- **Related concepts:** intrinsic-motivation [A3.1] (freedom is the soil intrinsic motivation grows in); autonomy-vs-direction [A7.3] (the leader holds the why, members hold the how); delegating-outcomes-not-tasks [A9.2] (freedom to choose how is delegation of outcomes).

### The spark vs. the sustained vehicle
concepts:    [A6.4 common-stall-patterns] [A2.5 transformational-vs-transactional] [A5.7 launch-and-relaunch]
...
- **Why it matters / evidence:** This is the entry for the leader whose group "lost momentum after a great start." Han's framing tells them the fix is structural, not motivational — build the vehicle. The corpus's mobilizing-vs-organizing lens lives here: the spark mobilizes; the vehicle organizes.
- **Related concepts:** launch-and-relaunch [A5.7] (the spark is the launch; the vehicle is what makes it stick); building-and-using-power [A7.1] (the vehicle is where power accumulates); transformational-vs-transactional [A2.5] (spark-only is transactional; the vehicle is transformational).
- **Source reach:** The cases are political/movement-scale; route program- and campaign-design specifics to H:org-level. The transferable kernel for a small-group leader is tight: *build the structure that holds energy after the spark.*

### Designing the group: composition, balance, and the launch
concepts:    [A5.1 composition-and-skills] [A5.2 group-size-and-nesting] [A5.7 launch-and-relaunch]
...
- **Why it matters / evidence:** For a first-time leader this is the highest-leverage, least-visible move: most of the outcome is set before anyone interacts. (Fisher's *The Collective Edge* carries the structure-before-process claim and the 3–7 size rule at full depth — cross-reference it; Undivided supplies the cross-difference-composition illustration.)
- **Related concepts:** group-size-and-nesting [A5.2] (small enough for real discussion); cross-cutting-ties-before-conflict [A4.6] (balanced composition is how you build bridges); launch-and-relaunch [A5.7] (the first session sets the conditions).
- **Source reach (org-check):** The *program-level* architecture — a 1,200-person cohort split across rooms, the curriculum, the facilitator-training pipeline — is org-level design and routes to **H:org-level**. What passes the leader gate is the part a single group leader controls: how they compose, size, and launch their own small working group. The mechanics of running the launch session itself route to **H:events**.

### Crafting roles to people's strengths
concepts:    [A5.4 work-and-task-design] [A9.1 developing-leaders] [A3.2 ownership-and-voice]
...
- **Why it matters / evidence:** For the leader who feels all the work falls on a few people, this is the move: the non-participants often aren't unwilling, they're mis-slotted. Han's example shows a tailored role converting an anxious would-be bystander into a committed, identifiable contributor.
- **Related concepts:** developing-leaders [A9.1] (a fitted role is the first step into leadership); delegating-outcomes-not-tasks [A9.2] (hand over an outcome that suits them); satisfaction-and-retention [A10.6] (people stay in roles that fit them).

### Bringing your full self: authenticity as a leader's instrument
...
- **Why it matters / evidence:** First-time leaders often feel they must hide uncertainty or feeling to seem credible. Han's account suggests the opposite trade: managed inauthenticity protects you in the short run but caps what you can lead people to; authenticity costs more and reaches further.
- **Related concepts:** lead-by-example [A1.3] (authentic risk-taking models it for the group); failure-as-learning [A1.6] (surviving the exposure reframes the risk); psychological-safety [A6.5] (a leader's openness widens what others will risk).
- **Source reach:** The scene is a public faith setting; the transferable kernel is the leadership stance (authentic > mirroring), not the content. Route nothing; keep at the leadership altitude where A1 lives permanently.

### Revolution by trial and error: the non-linear journey
concepts:    [A1.6 failure-as-learning] [A6.4 common-stall-patterns]
...
- **Why it matters / evidence:** This is the reassurance entry for a discouraged leader. Across a seven-year study, Han found that durability came not from anyone getting it right the first time but from people who kept adjusting and returning — the trial-and-error itself was the method.
- **Related concepts:** failure-as-learning [A1.6] (setbacks are information); resilience-through-setbacks [A10.5] (returning after a stumble); learning-together [A6.6] (the group corrects its course by reflecting).

### Peer accountability and ritual community against backlash
concepts:    [A8.3 peer-accountability-without-authority] [A6.1 how-norms-form-and-become-culture] [A10.4 collective-care]
...
- **Why it matters / evidence:** For a leader with no formal authority (the corpus's default), this is the accountability mechanism that actually works. Han contrasts it sharply with the failure mode of people who made themselves *less* accountable — reading and donating in private — and quietly drifted away.
- **Related concepts:** how-norms-form-and-become-culture [A6.1] (rituals harden into culture); collective-care [A10.4] (the ritual community is how the group cares for its people); resilience-through-setbacks [A10.5] (community is the buffer against backlash).

### The unequal cost: who carries the emotional labor
concepts:    [A10.4 collective-care] [A6.5 psychological-safety]
situations:
handoff:
anchors to:  Relationships across difference are the engine
...
- **Why it matters / evidence:** This is a caution the rest of the corpus doesn't carry: cross-difference groups have an equity problem *inside the group*. Han presents it as a continual, unresolved tension to manage, not a solved problem — which is exactly how a first-time leader should hold it.
- **Related concepts:** collective-care [A10.4] (relieving the burden is a care practice); cross-cutting-ties-before-conflict [A4.6] (the cost is the shadow side of bridging); psychological-safety [A6.5] (uneven cost undermines safety for the exposed members).
- **Source reach:** The book frames this in racial terms; the coach generalizes it to *any* salient power/identity difference in a group and attributes the emotional-labor concept to Hochschild. **Register-gap flag:** no leaf cleanly owns "equity of cost within the group"; tagged A10.4 + A6.5 as nearest, with A4.6 inline. See FLAG 1.

### Leading vs. mirroring: stand for something, or reflect the group back
concepts:    [A7.1 building-and-using-power] [A1.3 lead-by-example] [A2.1 shared-purpose]
...
- **Why it matters / evidence:** First-time leaders tend to read pushback as proof they led badly. Han's account reframes it — hearing it from both sides is the ordinary cost of leading toward something, not a failure signal; the seductive alternative, mirroring, produces a group that feels active but goes nowhere.
- **Related concepts:** shared-purpose [A2.1] (leading means holding a direction worth rallying to); bringing-your-full-self [A1.4] (authentic conviction is how you lead rather than mirror); autonomy-vs-direction [A7.3] (direct the *what* while leaving the *how* open).
- **Source reach:** The scene is a faith institution navigating a contested public issue; route the institutional-politics specifics to **H:org-level** and keep the transferable stance. A7 decision-making is otherwise thin in this source — this is the one place it surfaces, so tag lightly and don't overdraw it.

---


<!-- SEARCH_TERMS
han — undivided | undivided
domains: A4 | A2 | A6 | A8
leaves: A1.3 A1.4 A1.6 A10.1 A10.4 A10.5 A10.6 A2.1 A2.4 A2.5 A3.1 A3.2 A3.3 A3.4 A3.5 A4.1 A4.2 A4.3 A4.4 A4.5 A4.6 A5.1 A5.2 A5.4 A5.7 A6.1 A6.3 A6.4 A6.5 A6.6 A7.1 A7.3 A8.2 A8.3 A9.1 A9.2
keywords: relationships | relational-organizing | one-on-one | strategy | trust | purpose | story | shared-identity | values | goal-clarity | narrative | dynamics | lifecycle | momentum | psychological-safety | cohesion | belonging | conflict | dissent | accountability
situations: burning-out cant-make-decisions cant-recruit everyone-just-agrees group-feels-transactional group-lost-its-why group-too-big-or-chaotic i-cant-let-go i-feel-like-an-imposter lost-momentum-after-launch low-attendance newcomers-dont-stick no-one-takes-initiative two-members-clashing volunteers-flaky work-is-all-on-a-few-people
-->